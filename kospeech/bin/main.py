...
KSPONSPEECH_VOCAB_PATH = '/content/drive/MyDrive/kospeech/data/vocab/kspon_sentencepiece.vocab'
KSPONSPEECH_SP_MODEL_PATH = './content/drive/MyDrive/kospeech/data/vocab/kspon_sentencepiece.model'
LIBRISPEECH_VOCAB_PATH = '/content/drive/MyDrive/kospeech/data/vocab/tokenizer.vocab'
LIBRISPEECH_TOKENIZER_PATH = './content/drive/MyDrive/kospeech/data/vocab/tokenizer.model'
...
def train(config: DictConfig) -> nn.DataParallel:
    ...
    vocab = KsponSpeechVocabulary(
        f'/content/drive/MyDrive/kospeech/data/vocab/aihub_{config.train.output_unit}_vocabs.csv',
...
@hydra.main(config_path=os.path.join('/content/drive/MyDrive/kospeech/', "configs"), config_name="train")
