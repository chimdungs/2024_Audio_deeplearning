...
parser.add_argument('--dst_path', type=str, required=False, default = '/content/drive/MyDrive/Evaluation')
...
vocab = KsponSpeechVocabulary('/content/drive/MyDrive/kospeech/data/vocab/aihub_character_vocabs.csv')
...
dst_path = os.path.join(opt.dst_path, 'wer_results_4.txt')
