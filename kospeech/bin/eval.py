...
def inference(config: DictConfig):
    ...
    if config.eval.dataset == 'kspon':
        vocab = KsponSpeechVocabulary(
            f'/content/drive/MyDrive/kospeech/data/vocab/aihub_{config.eval.output_unit}_vocabs.csv', output_unit=config.eval.output_unit
        )
    elif config.eval.dataset == 'libri':
        vocab = LibriSpeechVocabulary('/content/drive/MyDrive/kospeech/data/vocab/tokenizer.vocab', '/content/drive/MyDrive/kospeech/data/vocab/tokenizer.model')
    else:
...
@hydra.main(config_path=os.path.join('/content/drive/MyDrive/kospeech/', "configs"), config_name="eval")
